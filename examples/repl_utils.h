...
std::string getStringList(const std::vector<std::string> &bad_words, const std::string &sep);

std::vector<std::string> getWordsVector(const std::string &input, bool skip_first = true);
